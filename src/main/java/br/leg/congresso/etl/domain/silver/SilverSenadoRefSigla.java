...
/**
 * Tabela de referência: siglas de processos legislativos.
 * Fonte: GET /dadosabertos/processo/siglas
 * Estratégia: Full replace (truncate + insert) — dados estáticos.
 */
@Entity
@Table(schema = "silver", name = "senado_ref_sigla")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class SilverSenadoRefSigla {
