...
/**
 * Entidade Silver — membros de grupos de trabalho da Câmara.
 * Espelha o CSV gruposMembros.csv.
 * Chave de deduplicação: (id_deputado, id_grupo).
 */
@Entity
@Table(schema = "silver", name = "camara_grupo_membro", uniqueConstraints = @UniqueConstraint(name = "uq_silver_camara_grupo_membro_nat_key", columnNames = {
        "id_deputado", "id_grupo", "data_inicio" }))
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
@ToString
public class SilverCamaraGrupoMembro {
