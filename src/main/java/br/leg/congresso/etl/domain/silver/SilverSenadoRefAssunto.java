...
/**
 * Tabela de referência: assuntos legislativos.
 * Fonte: GET /dadosabertos/processo/assuntos
 * Estratégia: Full replace (truncate + insert) — dados estáticos.
 */
@Entity
@Table(schema = "silver", name = "senado_ref_assunto")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class SilverSenadoRefAssunto {
    ...
    @Column(name = "assunto_geral", length = 500)
    private String assuntoGeral;

    @Column(name = "assunto_especifico", length = 500)
