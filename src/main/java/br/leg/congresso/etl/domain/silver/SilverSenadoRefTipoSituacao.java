...
/**
 * Tabela de referência: tipos de situação possíveis em Processos Legislativos.
 * Fonte: GET /dadosabertos/processo/tipos-situacao
 * Estratégia: Full replace (truncate + insert) — dados estáticos.
 */
@Entity
@Table(schema = "silver", name = "senado_ref_tipo_situacao")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class SilverSenadoRefTipoSituacao {
